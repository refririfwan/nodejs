...
export default class CreateTodo extends Component {
    ...
    onSubmit(e){
        ...
        console.log((`Todo Descripton: ${this.state.todo_description}`));
        console.log((`Todo Responsible: ${this.state.todo_responsible}`));
        console.log((`Todo Priority: ${this.state.todo_priority}`));
        console.log((`Todo Completed: ${this.state.todo_compeleted}`));
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="from-group">
                        <div className="form-check form-check-inline">
                            ...
                            value="Low"
                            checked={this.state.todo_priority==='Low'} onChange={this.onChangeTodoPriority}
                            ></input>
                        ...
                        <div className="form-check form-check-inline">
                            ...
                            value="Medium"
                            checked={this.state.todo_priority==='Medium'} onChange={this.onChangeTodoPriority}
                            ></input>
                        ...
                        <div className="form-check form-check-inline">
                            ...
                            value="High"
                            checked={this.state.todo_priority==='High'} onChange={this.onChangeTodoPriority}
                            ></input>
